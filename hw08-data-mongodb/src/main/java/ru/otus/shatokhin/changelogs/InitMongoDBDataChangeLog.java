...
public class InitMongoDBDataChangeLog {
    ...
    public void initBooks(BookRepository repository) {
        gameOfThrones = repository.save(new Book("Game of Thrones", 1996, martin,
                Sets.newHashSet("Fantasy", "Adventure")));
        theIdiot = repository.save(new Book("The Idiot", 1868, dostoevsky,
                Sets.newHashSet("Novel")));
        theBrothersKaramazov = repository.save(new Book("The Brothers Karamazov", 1879, dostoevsky,
                Sets.newHashSet("Novel")));
    }
